<div class="overflow-x-auto">
    <table class="w-full text-left text-sm text-stone-600">
        <thead class="bg-stone-50/50 text-stone-500 font-medium border-y border-stone-200 text-[13px] uppercase tracking-wider">
            <tr>
                <th scope="col" class="px-6 py-4 font-semibold">Informasi Pegawai</th>
                <th scope="col" class="px-6 py-4 font-semibold">Bidang</th>
        ...
        <tbody class="divide-y divide-stone-100 bg-white">
            ...
            <tr class="hover:bg-stone-50/80 transition-colors">
                ...
                <td class="px-6 py-4">
                    ...
                    <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-emerald-50 text-emerald-700 border border-emerald-200 text-xs font-bold uppercase tracking-wider">
                        <span class="w-1.5 h-1.5 rounded-full bg-emerald-500"></span> Aktif
                    </span>
                    @else
                    <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-stone-100 text-stone-600 border border-stone-300 text-xs font-bold uppercase tracking-wider">
                        Non-Aktif
                    </span>
                    @endif
                </td>
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <div class="flex items-center justify-end gap-1">
                        <x-action-dropdown>
                            ...
                            <x-action-dropdown-item href="{{ route('anggota.edit', $anggota->id) }}" icon='<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>'>
                                Ubah Data
                            </x-action-dropdown-item>

<style>
    @media (min-width: 1024px) {
        ...
        /* Dynamic Collapsed State styling (48px Width) */
...
<aside id="sidebar" 
       ...
       class="w-72 bg-[#ffffff] text-stone-800 flex flex-col fixed h-full z-[80]
              -translate-x-full lg:translate-x-0 transition-all duration-300 shadow-[4px_0_24px_rgba(0,0,0,0.03)] border-r border-stone-200/50
              lg:ml-6 lg:rounded-[24px] lg:shadow-[0_8px_30px_rgba(0,0,0,0.02)] lg:border lg:border-stone-200/40">
    ...
    <div class="px-6 h-[100px] flex items-center gap-4 shrink-0 lg:hidden">
        ...
        <div class="flex flex-col min-w-0 pb-1 mt-2.5">
            <h1 class="text-[21px] font-medium tracking-tight text-stone-800 leading-tight truncate">
                Tirta Bina Karya
            </h1>
            <p class="text-[13px] text-stone-500 font-normal mt-0.5 truncate">
    ...
    {{-- User Info --}}
    <div :class="isPinned || isHovered ? 'px-4 py-2.5' : 'lg:p-1.5'"
         class="bg-black/5 border-t border-stone-300/30 shrink-0 transition-all duration-300">
        <div :class="isPinned || isHovered ? 'justify-between' : 'lg:justify-center lg:gap-0'"
             class="flex items-center gap-3 transition-all duration-300">
            <div :class="isPinned || isHovered ? 'w-10 h-10 rounded-xl' : 'lg:w-9 lg:h-9 lg:rounded-full'" 
            ...
            <div x-show="isPinned || isHovered" x-transition.opacity class="flex items-center gap-1 shrink-0">
                ...
                <button type="button" @click="isPinned = !isPinned" 
                        ...
                        :class="isPinned ? 'text-emerald-700 bg-emerald-500/10 hover:bg-emerald-500/20' : 'text-stone-400 hover:text-stone-600 hover:bg-stone-200/50'">

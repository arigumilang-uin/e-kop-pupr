...
<div class="sticky top-[92px] z-30 -mx-4 sm:-mx-6 px-4 sm:px-6 py-4 bg-[#f7f7f5]/95 backdrop-blur-xl border-b border-stone-200/60 transition-all duration-200">
    <div class="flex items-center lg:justify-end gap-3">
        ...
        <div class="relative shrink-0" x-data="{ openFilter: false }" @click.away="openFilter = false">
            <button @click="openFilter = !openFilter" type="button" class="relative flex items-center justify-center w-[44px] sm:w-[46px] lg:w-auto lg:px-4 h-[44px] sm:h-[46px] bg-white border border-stone-200 text-stone-600 rounded-xl hover:bg-stone-50 focus:ring-2 focus:ring-[#043d2e]/20 transition-all shadow-sm">
            ...
            <div x-show="openFilter" 
                 ...
                 class="absolute right-0 top-full mt-3 w-[320px] sm:w-[360px] md:w-[420px] p-5 bg-white border border-stone-200 rounded-2xl shadow-xl z-50 flex flex-col gap-4 origin-top-right ring-1 ring-black/5"
                 style="display: none;">
                
                <div class="flex items-center justify-between border-b border-stone-100 pb-3 -mx-5 px-5 -mt-2">
                    <h3 class="text-sm font-bold text-stone-800">Filter Spesifik</h3>
                    <button @click="openFilter = false" type="button" class="text-stone-400 hover:text-stone-600 bg-stone-50 hover:bg-stone-100 p-1 rounded-lg transition-colors">

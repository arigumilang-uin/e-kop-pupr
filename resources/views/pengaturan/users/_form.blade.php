...
<div class="space-y-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
            ...
            @if($isEdit && $user->id === 1)
                {{-- Super Admin utama tidak boleh diubah rolenya --}}
                <input type="text" disabled value="Super Admin" class="w-full px-4 py-2.5 rounded-xl border border-stone-300 text-sm text-stone-500 bg-stone-100 font-bold outline-none cursor-not-allowed">
